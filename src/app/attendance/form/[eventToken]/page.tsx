      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
        <Card className="max-w-md w-full p-8 text-center">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Your attendance has been successfully recorded. God bless you!
          </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800">
      ...
      <div className="hero-gradient text-white py-8 px-4">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-blue-100 text-sm">
            Please fill out the form below to record your attendance.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 -mt-4 pb-8">
        ...
        {/* Attendance Form */}
        <Card className="p-6">
          <h3 className="font-[family-name:var(--font-playfair)] text-base font-bold text-slate-800 dark:text-white mb-5">
            Your Details
          </h3>
          ...
          <form action={formAction}>
            ...
            <div className="space-y-5">
              ...
              <div>
                <label
                  htmlFor="fullName"
                  className="flex items-center gap-2 text-sm font-semibold text-slate-700 dark:text-slate-200 mb-2"
                >
              ...
              <div>
                ...
                <input
                  ...
                  id="memberId"
                  name="memberId"
                  placeholder="Enter your member ID if you have one"
                  className="w-full px-4 py-3 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-800 dark:text-white placeholder-slate-400 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition text-base"
                />
              </div>
              ...
              <div>
                <label
                  ...
                  className="flex items-center gap-3 p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-amber-50 dark:bg-amber-900/20 cursor-pointer hover:border-accent transition"
                >
                  <input
                    type="checkbox"
                    id="isFirstTimer"
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                      Check this box if this is your first time attending
                    </p>
                  </div>
                </label>
              </div>
